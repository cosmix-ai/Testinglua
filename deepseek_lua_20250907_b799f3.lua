...
-- ขนาดและตำแหน่งสำหรับมือถือ
local iconSize = isMobile and 60 or 48
local mainFrameWidth = isMobile and 400 or 520
local mainFrameHeight = isMobile and 280 or 320
...
TitleText.Size = UDim2.new(0, 220, 0, isMobile and 40 or 35)
TitleText.Position = UDim2.new(0.5, -110, 0, 0)
TitleText.BackgroundTransparency = 1
TitleText.Text = "COMIC HUB"
...
ScriptsContainer.Size = UDim2.new(1, -20, 1, -(isMobile and 55 or 50))
ScriptsContainer.Position = UDim2.new(0, 10, 0, isMobile and 50 or 45)
...
local function loadScripts()
    ...
    local success, err = pcall(function()
        ...
        for i, s in ipairs(scripts) do
            ...
            scriptButton.Size = UDim2.new(0, isMobile and 160 or 180, 0, isMobile and 100 or 120)
